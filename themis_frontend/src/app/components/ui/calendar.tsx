...
// import { buttonVariants } from "@/components/ui/button" // Asegúrate de que esta ruta sea correcta

// Local buttonVariants function
const buttonVariants = ({ variant }: { variant?: "default" | "outline" | "ghost" }) => {
  ...
  switch (variant) {
    ...
    case "ghost":
      return `${baseClasses} hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2`
    default:
