...
const CaseTracking: React.FC = () => {
  ...
  const fetchFollowUps = async () => {
    ...
    try {
      ...
      // graphqlRequest devuelve el objeto 'data' ya procesado por el cliente
      // result === { allFollowUps: { data: [...] , totalPages, ... } }
  ...
  const filteredCases = React.useMemo(() => {
    ...
    return followUpsData.allFollowUps.data.filter((caseItem: any) => {
      const studentName = caseItem.student?.person
        ? `${caseItem.student.person.name} ${caseItem.student.person.lastname}`.toLowerCase()
        : ""
      const teacherName = caseItem.teacher?.person
        ? `${caseItem.teacher.person.name} ${caseItem.teacher.person.lastname}`.toLowerCase()
        : ""
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-3 sm:p-4 md:p-8 lg:p-10 w-full">
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="relative">
          ...
          <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 dark:from-slate-100 dark:via-slate-200 dark:to-slate-300 bg-clip-text text-transparent">
            ...
            <Button
              ...
              className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white shadow-lg transition-all duration-200 rounded-xl px-4 sm:px-6 py-2 sm:py-3 dark:bg-blue-900/80 hover:dark:bg-blue-900/90 w-full sm:w-auto justify-center"
            >
        ...
        {/* Alerts */}
        {successMsg && (
          <Alert className="border-emerald-200 bg-gradient-to-br from-emerald-50 to-green-50 dark:from-emerald-950/20 dark:to-green-950/20 dark:border-emerald-800/50 rounded-xl shadow-lg">
        ...
        {/* Main Card */}
        <Card className="border-slate-200/50 dark:border-slate-700/50 shadow-2xl shadow-slate-200/50 dark:shadow-slate-950/50 rounded-2xl overflow-hidden bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl">
          <CardHeader className="border-b border-slate-200/50 dark:border-slate-700/50 bg-gradient-to-br from-slate-50/50 to-transparent dark:from-slate-800/50 p-4 sm:p-6">
            <div className="flex flex-col gap-4">
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-slate-100">Lista de Casos</h2>
              <div className="relative w-full">
                ...
                <Input
                  ...
                  className="pl-10 sm:pl-12 w-full h-10 sm:h-12 rounded-xl border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm focus:ring-2 focus:ring-sky-500/20 text-sm sm:text-base"
                />
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-3 sm:p-6">
            ...
            {/* Pagination */}
            {followUpsData?.allFollowUps?.totalPages > 1 && (
              <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-3 mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-slate-200/50 dark:border-slate-700/50">
                <Button
                  variant="outline"
                ...
                <div className="flex items-center gap-2 flex-wrap justify-center">
                  {Array.from({ length: Math.min(5, followUpsData.allFollowUps.totalPages) }, (_, i) => {
                    const page = i
                    return (
                      <Button
                        key={page}
                        ...
                        className={
                          currentPage === page
                            ? "rounded-xl bg-gradient-to-r from-green-800 to-green-600 min-w-[40px] h-9 sm:h-10"
                            : "rounded-xl min-w-[40px] h-9 sm:h-10"
                        }
                      >
                        {page + 1}
                      </Button>
                ...
                <Button
                  variant="outline"
                  onClick={() => setCurrentPage(Math.min(followUpsData.allFollowUps.totalPages - 1, currentPage + 1))}
                  disabled={currentPage === followUpsData.allFollowUps.totalPages - 1}
                  className="rounded-xl w-full sm:w-auto text-sm sm:text-base"
                >
                  Siguiente
                </Button>
              ...
              <div className="pt-1 pb-1">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                  <div className="space-y-2">
                    ...
                    >
                      <SelectTrigger>
                        <SelectValue>{formData.studentName || (loadingStudents ? "Cargando..." : "Seleccione un aprendiz")}</SelectValue>
                      </SelectTrigger>
                      <SelectContent>
                        {students.length === 0 && (
                          <div className="px-4 py-2 text-gray-500">No hay aprendices disponibles</div>
                        )}
            ...
            <DialogContent className="max-w-4xl w-full max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-8">
              ...
              <div className="space-y-6 mt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-muted-foreground dark:text-white">Fecha de Creación</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-muted-foreground dark:text-white">Tipo de Seguimiento</Label>
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-muted-foreground dark:text-white">Aprendiz</Label>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-muted-foreground dark:text-white">Instructor</Label>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    <Label className="text-sm font-medium text-muted-foreground dark:text-white">Estado del Flujo</Label>
                    <p className="text-base text-foreground dark:text-white font-medium">
                ...
                <div className="space-y-2">
                  <Label className="text-sm font-medium text-muted-foreground dark:text-white">Descripción del Caso</Label>
